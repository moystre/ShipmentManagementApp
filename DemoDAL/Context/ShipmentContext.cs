...
namespace DAL.Context
{
    public class ShipmentContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>().HasMany(c => c.Shipments).WithOne(s => s.Customer).HasForeignKey(s => s.CustomerId);
            //Shipment - Container (Many to One)
            modelBuilder.Entity<Shipment>().HasMany(s => s.Containers).WithOne(co => co.Shipment).HasForeignKey(co => co.ShipmentId);
            modelBuilder.Entity<Container>().HasOne(co => co.Shipment).WithMany(s => s.Containers).HasForeignKey(co => co.ShipmentId);
